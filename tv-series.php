        ...
        <ul>
          <?php
            foreach($tv_top->results as $tt){
              ...
              echo '<li><a href="tvshow.php?id=' . $tt->id . '"><img src="'.$imgurl_1.''. $tt->poster_path . '"><h4>' . $tt->original_name . "</h4><h5><em>First Air Date : ".$tt->first_air_date."<br />Popularity : " . round($tt->popularity) . "</em></h5></a></li>";
            }
          ?>
        </ul>
      </div>
